...
public final class Paths {
    ...
    public static List<String> DIRECTORY_NAMES = List.of(
        ".",
        "..",
        ".anydesk",
        ".aptitude",
    ...
    // Copied over from AikidoSec/firewall-node
    // https://github.com/AikidoSec/firewall-node/blob/main/library/vulnerabilities/attack-wave-detection/paths/fileNames.ts
    public static List<String> FILE_NAMES = List.of(
        ".addressbook",
        ".atom",
        ".bashrc",
        ".boto",
