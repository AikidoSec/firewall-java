...
public class BuildRouteFromUrlTest {
    ...
    void testReplaceNumbers() {
        ...
        assertEquals("/posts/:number", buildRouteFromUrl("http://localhost/posts/3/"));
        assertEquals("/posts/:number/comments/:number", buildRouteFromUrl("http://localhost/posts/3/comments/10"));
        assertEquals("/blog/:number/:number/great-article", buildRouteFromUrl("/blog/2023/05/great-article"));
    }
    ...
    void testReplaceDates() {
        ...
        assertEquals("/posts/:date", buildRouteFromUrl("/posts/2023-05-01/"));
        assertEquals("/posts/:date/comments/:date", buildRouteFromUrl("/posts/2023-05-01/comments/2023-05-01"));
    ...
    void testReplaceIpAddresses() {
        ...
        assertEquals("/block/:ip", buildRouteFromUrl("/block/2001:2:ffff:ffff:ffff:ffff:ffff:ffff"));
