...
public class ThreadCacheObjectTest {
    @Test
    public void update() {
        ThreadCacheObject tCache = new ThreadCacheObject(
                null,
                null,
                null,
                null,
                Optional.of(new ReportingApi.APIListsResponse(
                        List.of(new ReportingApi.ListsResponseEntry(
                                "geoip",
                                "description",
                                List.of(
                                        "1.2.3.4",
        ...
        assertEquals(
                new ThreadCacheObject.BlockedResult(true, "description"), tCache.isIpBlocked("fd00:1234:5678:9abc::1"));
        assertEquals(new ThreadCacheObject.BlockedResult(false, null), tCache.isIpBlocked("fd00:1234:5678:9abc::2"));
        assertEquals(
                new ThreadCacheObject.BlockedResult(true, "description"), tCache.isIpBlocked("fd00:3234:5678:9abc::1"));
        assertEquals(
                new ThreadCacheObject.BlockedResult(true, "description"), tCache.isIpBlocked("fd00:3234:5678:9abc::2"));
        ...
        assertFalse(tCache.isBlockedUserAgent(
        ...
        assertFalse(
                tCache.isBlockedUserAgent(
                        "Mozilla/5.0 (Linux; Ubuntu; X11) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36"));
        assertFalse(tCache.isBlockedUserAgent(
                "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Opera/77.0.4054.90"));
    }
