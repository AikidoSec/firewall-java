...
public class ThreadCacheTest {
    ...
    private ThreadIPCClient mockClient;

    @BeforeEach
    public void setUp() {
        mockClient = Mockito.mock(ThreadIPCClient.class);
    ...
    public void testGetCacheWhenNotExpired() {
        ...
        ThreadCacheObject expectedCache =
                new ThreadCacheObject(Collections.emptyList(), blockedUserIds, Set.of(), routes, Optional.empty());
    ...
    /*
       ...
       public void testGetCacheWhenExpired() throws InterruptedException {
           ...
           // Mock the ThreadIPCClient to return a new cache
