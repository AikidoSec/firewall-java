...
public class ShouldRateLimitTest {
    ...
    public void testRateLimitsByIp() {
        ...
        endpoints.add(new Endpoint(
                "POST", "/login", /*maxRequests*/ 3, /*windowSizeMS*/ 1000, List.of(), false, false, true));
        ...
        assertEquals(
                new ShouldRateLimit.RateLimitDecision(false, null),
        ...
        assertEquals(
                ...
                ShouldRateLimit.shouldRateLimit(routeMetadata, null, remoteAddress, connectionManager));
        assertEquals(
                new ShouldRateLimit.RateLimitDecision(true, "ip"),
                ShouldRateLimit.shouldRateLimit(routeMetadata, null, remoteAddress, connectionManager));
    }
    ...
    public void testRateLimitingByUser() {
        ...
        assertEquals(
                new ShouldRateLimit.RateLimitDecision(true, "user"),
    ...
    public void testRateLimitingWithWildcard() {
        List<Endpoint> endpoints = new ArrayList<>();
        endpoints.add(new Endpoint(
                "POST", "/api/*", /*maxRequests*/ 3, /*windowSizeMS*/ 1000, List.of(), false, false, true));
    ...
    public void testRateLimitingWithWildcard2() {
        List<Endpoint> endpoints = new ArrayList<>();
        endpoints.add(
                new Endpoint("*", "/api/*", /*maxRequests*/ 3, /*windowSizeMS*/ 1000, List.of(), false, false, true));
    ...
    public void testRateLimitingByUserWithDifferentIps() {
        ...
        assertEquals(
                ...
                ShouldRateLimit.shouldRateLimit(
                        metadata, new User("123", "User 123", "1.2.3.4", 0), "1.2.3.4", connectionManager));

        // First request from second IP
        assertEquals(
                new ShouldRateLimit.RateLimitDecision(false, null),
                ShouldRateLimit.shouldRateLimit(
                        metadata, new User("123", "User 123", "4.3.2.1", 0), "4.3.2.1", connectionManager));
    ...
    public void testRateLimitingSameIpDifferentUsers() {
        ...
        assertEquals(
                new ShouldRateLimit.RateLimitDecision(false, null),
                ShouldRateLimit.shouldRateLimit(
                        metadata, new User("123456", "User 456", "1.2.3.4", 0), "1.2.3.4", connectionManager));
    ...
    public void testRateLimitingBypassedIpWithUser() {
        ...
        CloudConnectionManager connectionManager =
                createConnectionManager(endpoints, new HashSet<>(Arrays.asList("1.2.3.4")));
