...
spring_postgres_groovy_app.add_payload("sql",
...
spring_postgres_groovy_app.add_payload("command injection",
...
spring_postgres_groovy_app.add_payload("server-side request forgery",
...
spring_postgres_groovy_app.add_payload("server-side request forgery, to itself",
    safe_request=Request("/api/requests/get", data_type='form', body={"url": "http://localhost:8094/"}),
    unsafe_request=Request("/api/requests/get", data_type='form', body={"url": "http://localhost:5000"})
)
spring_postgres_groovy_app.add_payload("path traversal",
