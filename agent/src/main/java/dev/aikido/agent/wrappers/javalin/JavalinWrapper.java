    ...
    public class JavalinAdvice {
        ...
        public static JavalinServletContext before(
            ...
            ContextObject context = new JavalinContextObject(
                    ctx.method().name(), ctx.url(), ctx.ip(), ctx.queryParamMap(), ctx.cookieMap(), ctx.headerMap());
        ...
        public static void after(@Advice.Enter(typing = DYNAMIC) JavalinServletContext ctx) {
