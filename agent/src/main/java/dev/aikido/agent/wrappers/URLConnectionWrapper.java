...
public class URLConnectionWrapper implements Wrapper {
    ...
    public ElementMatcher<? super MethodDescription> getMatcher() {
        return isConstructor()
                .and(isDeclaredBy(isSubTypeOf(HttpURLConnection.class).or(nameContainsIgnoreCase("URLConnection"))));
    }

    @Override
    public ElementMatcher<? super TypeDescription> getTypeMatcher() {
        return ElementMatchers.isSubTypeOf(URLConnection.class)
                .and(not(
                        // Names to be ignored :
    ...
    public static class ConstructorAdvice {
        ...
        public static void before(@Advice.This(typing = DYNAMIC) Object target) throws Exception {
