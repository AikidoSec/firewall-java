...
test:
	AIKIDO_LOG_LEVEL="debug" AIKIDO_TOKEN="token" ./gradlew test

cov:
	AIKIDO_LOG_LEVEL="debug" AIKIDO_TOKEN="token" ./gradlew test --rerun-tasks -PcoverageRun jacocoTestReport
